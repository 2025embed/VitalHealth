...
set "CUBEPROGRAMMER_TOOL_PATH=E:\st programmer\bin"
...
:: Sign the app 
"%CUBEPROGRAMMER_TOOL_PATH%\STM32_SigningTool_CLI.exe" -s -bin "%BIN_DIR%STM32N6570-DK_FSBL.bin" -nk -of 0x70000000 -t fsbl -o "%OUT_DIR%STM32N6570-DK_FSBL-trusted.bin" -hv 2.3 -dump "%OUT_DIR%STM32N6570-DK_FSBL-trusted.bin"
